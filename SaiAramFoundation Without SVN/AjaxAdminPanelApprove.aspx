<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxAdminPanelApprove.aspx.cs"
    Inherits="SaiAramFoundation.AjaxAdminPanelApprove" %>
        ...
        <asp:GridView ID="gvDisplayScholarship" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Process" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:HyperLink ID="lnkApprove" class="inline1" NavigateUrl='<%#"ScholarshipApprove.aspx?applnno=" + Eval("Application_Id")+ "&scholarshipId=" +Eval("Scholarship_Id") %>'
                            runat="server" Text='<%#Eval("ApproveText") %>' Visible='<%#Convert.ToBoolean(Eval("ProcessLinkText")) %>'></asp:HyperLink>
                         <asp:HyperLink ID="lblOverride" class="inline1" NavigateUrl='<%#"ScholarshipOverride.aspx?applnno=" + Eval("Application_Id")+ "&scholarshipId=" +Eval("Scholarship_Id") %>'
                            runat="server" Text="Override" Visible='<%#Convert.ToBoolean(Eval("RejectApprovalLinkText")) %>'></asp:HyperLink>
                             <asp:HyperLink ID="lblApprovedOverride" class="inline1" NavigateUrl='<%#"ScholarshipOverride.aspx?applnno=" + Eval("Application_Id")+ "&scholarshipId=" +Eval("Scholarship_Id") %>'
                            runat="server" Text="Override" Visible='<%#Convert.ToBoolean(Eval("ApprovedOverrideLinkText")) %>'></asp:HyperLink>
                        <asp:Label ID="lblApproved" runat="server" Text="Approved" style="font-weight: bold;color:#FF00EA;font-size: 15px;" Visible='<%#Convert.ToBoolean(Eval("lblApproved")) %>'></asp:Label>
                         <asp:Label ID="lblRejected" runat="server" Text="Rejected" style="font-weight: bold;color:red;font-size: 15px;" Visible='<%#Convert.ToBoolean(Eval("lblRejected")) %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width="80px"></ItemStyle>
                </asp:TemplateField>
