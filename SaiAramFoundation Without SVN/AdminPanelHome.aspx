<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true"
    CodeBehind="AdminPanelHome.aspx.cs" Inherits="SaiAramFoundation.AdminPanel" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(
         ...
         function OnLoadBind() {
             ...
             var chkbx = document.getElementById("<% =chkDefaultView.ClientID%>").checked;
             ...
             xmlhttp.open("GET", "AjaxAdminPanelHome.aspx?MainCategory=" + MaincatText + "&Key=" + Key + "&SelectedStatusText=" +
              SelectedStatusText + "&fromdate=" + fromdate + "&todate=" + todate + "&checkvalue=" + chkbx + "&AcyearId=" + AcyearId, true);
             xmlhttp.send();
         ...
         function gridshow() {
             ...
             xmlhttp.open("GET", "AjaxAdminPanelHome.aspx?MainCategory=" + MaincatText + "&Key=" + Key + "&SelectedStatusText=" + SelectedStatusText + "&fromdate=" + fromdate + "&todate=" + todate + "&checkvalue=" + chkbx + "&AcyearId=" + AcyearId, true);
             xmlhttp.send();
         ...
         function gridshow1() {
             ...
             var Maincat = document.getElementById("<% =ddlMainCategory.ClientID%>")
             //var MaincatText = Maincat.options[Maincat.selectedIndex].text;
             var MaincatText = "Application No";
             var Key = document.getElementById("<% =txtKey.ClientID%>").value;
             var fromdate = document.getElementById("<% =txtfromDate.ClientID%>").value;
             var todate = document.getElementById("<% =txttoDate.ClientID%>").value;
             var SelectedStatus = document.getElementById("<% =ddlSelectedStatus.ClientID%>")
    ...
    <form runat="server">
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <asp:DropDownList ID="ddAcyear" runat="server" onchange="OnLoadBind()" Style="margin-right: 600px;">
                    </asp:DropDownList>
                </div>
                <!-- /.navbar-collapse -->
            </div>
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <asp:CheckBox ID="chkDefaultView" runat="server" Text="Detailed View" CssClass="button"
                    onchange="gridshow1()" />
            </div>
            <div class="col-md-2">
        ...
        <div>
            <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSearch">
                ...
                <%-- <asp:CheckBox ID="ChkAllDetails" runat="server" />--%>
