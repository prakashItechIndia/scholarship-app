<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScolarshipReSuggest.aspx.cs"
    Inherits="SaiAramFoundation.ScolarshipReSuggest" %>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="4" style="background: #CCC">
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td class="lblData">
                            ...
                            <asp:RegularExpressionValidator ID="revLastName" runat="server" ErrorMessage="Numeric,Special characters not allowed" Display="Dynamic"
                        ...
                        <td class="lblData">
                          ...
                          <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter AadhaarID" Display="Dynamic"
                                ControlToValidate="txtAadhaarID" SetFocusOnError="True"></asp:RequiredFieldValidator>--%>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator19" runat="server"
                                ControlToValidate="txtAadhaarID" ErrorMessage="Enter only Numbers" SetFocusOnError="True" Display="Dynamic"
                                ValidationExpression="[0-9]*"></asp:RegularExpressionValidator>
                            <asp:CustomValidator ID="CustomValidator3" runat="server" ControlToValidate="txtAadhaarID" Display="Dynamic"
                    ...
                    <tr bgcolor="#FFFFFF">
                        <td colspan="2">
                            ...
                            <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Please check whether student name is correct or not!" Display="Dynamic"
                                ClientValidationFunction="ValidateCheckBox"></asp:CustomValidator>
                        </td>
                        <td colspan="2">
                            <asp:CheckBox runat="server" ID="chkAadhaarID" />
                            <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="Please check whether AadhaarID is correct or not!" Display="Dynamic"
                                ClientValidationFunction="ValidateCheckBox1"></asp:CustomValidator>
                        </td>
                    </tr>
                     <tr>
                        ...
                        <td class="lblData" bgcolor="#FFFFFF">
                          ...
                          <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please enter Pan Number"
                            ...
                            <asp:CustomValidator ID="CustomValidator4" runat="server" ControlToValidate="txtPanId"  Display="Dynamic"
                                ErrorMessage="You must enter 10 digits Alpha-Numeric!" ClientValidationFunction="validateLengthPanId" ></asp:CustomValidator>
                        </td>
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td width="26%">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please enter father's name" Display="Dynamic"
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ErrorMessage="Numeric,Special characters not allowed"
                                ControlToValidate="txtFatherName" ValidationExpression="^[a-zA-Z\s-.]{1,50}$" Display="Dynamic"
                        ...
                        <td width="26%" valign="top">
                            ...
                            <asp:RequiredFieldValidator SetFocusOnError="True" ID="rfvOccupation" ControlToValidate="ddlFatherOccupathion"
                                Text="Please select occupation" runat="server" InitialValue="0" Display="Dynamic" />
                            <div class="form-group col-md-14" id="dvOtherFatherOccupation" runat="server" visible="false">
                                <asp:TextBox class="form-control" ID="txtOtherFatherOccupation" runat="server" MaxLength="95" Style="width: 85%"></asp:TextBox>
                            ...
                            <div class="form-group col-md-14" id="dvFatherOccupathionSaiRam" runat="server" visible="false">
                                <asp:DropDownList class="form-control" ID="ddlFatherOccupathionSaiRam" runat="server" Style="width: 85%">
                                    ...
                                    <asp:ListItem Value="Sai Matriculation Hr Sec School,West Tambaram,Chennai">Sai Matriculation Hr Sec School,West Tambaram,Chennai</asp:ListItem>
                                ...
                                <asp:RequiredFieldValidator ID="rfvFatherOccupathionSaiRam" runat="server" ErrorMessage="Please select occupation" Display="Dynamic"
                                    ControlToValidate="ddlFatherOccupathionSaiRam" SetFocusOnError="True" InitialValue="0" Enabled="false"></asp:RequiredFieldValidator>
                            </div>
                        </td>
                    </tr>
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td valign="top">
                            ...
                            <div class="form-group col-md-14" id="dvOtherMotherOccupathion" runat="server" visible="false">
                                <asp:TextBox class="form-control" ID="txtOtherMotherOccupation" runat="server" MaxLength="95" Style="width: 85%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rvfOtherMotherOccupation" runat="server" ErrorMessage="Please enter other occupation" Display="Dynamic"
                                    ControlToValidate="txtOtherMotherOccupation" SetFocusOnError="True" Enabled="false"></asp:RequiredFieldValidator>
                            </div>
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td valign="top">
                            ...
                            <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please enter Guardian name"
                                ControlToValidate="txtGuardianName" SetFocusOnError="True"></asp:RequiredFieldValidator>--%>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="Dynamic"
                                ErrorMessage="Numeric,Special characters not allowed" ControlToValidate="txtGuardianName"
                                ValidationExpression="^[a-zA-Z\s-.]{1,50}$" SetFocusOnError="True">
                            </asp:RegularExpressionValidator>
                        </td>
                        <td valign="top">
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td valign="top">
                            ...
                            <asp:RequiredFieldValidator SetFocusOnError="True" ID="rfvAddrLine1" ControlToValidate="txtAddressLine1"
                                Text="Please enter address line1" runat="server" Display="Dynamic" />
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td valign="top">
                            ...
                            <div id="divtxtcountry" runat="server">
                                <asp:TextBox CssClass="form-control" ID="txtCountry" runat="server" MaxLength="25" Display="Dynamic"
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td valign="top">
                            <div id="divddlstate" runat="server">
                                <asp:DropDownList ID="ddlState" runat="server" CssClass="form-control" AutoPostBack="true" Display="Dynamic"
                            ...
                            <div id="divtxtstate" runat="server">
                                <asp:TextBox CssClass="form-control" ID="txtState" runat="server" MaxLength="25" Display="Dynamic"
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td valign="top">
                            ...
                            <asp:RegularExpressionValidator ID="regtxtBirthDate1" runat="server" ErrorMessage="Enter valid date dd/MM/YYYY" Display="Dynamic"
                            ...
                            <asp:RequiredFieldValidator ID="rfvDOB" ControlToValidate="txtDOB" targetcontrolid="txtDOB" Display="Dynamic"
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td valign="top">
                            ...
                            <asp:RegularExpressionValidator ID="revEmail" runat="server" ErrorMessage="Enter valid email id" Display="Dynamic"
