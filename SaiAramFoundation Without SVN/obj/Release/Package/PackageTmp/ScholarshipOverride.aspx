<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScholarshipOverride.aspx.cs"  Inherits="SaiAramFoundation.ScholarshipOverride" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function fnConfirm() {
            if (document.getElementById('<%= txtApprovedAmt.ClientID %>').value > parseInt(document.getElementById('<%= lblSuggestedAmount.ClientID %>').innerHTML)) {
                var res = confirm("Approved Amt is greater than Suggested Amt. Are you sure you want to continue?");
                if (res == false) {
                ...
                ValidatorEnable(document.getElementById('<%= reQApprovedAmount.ClientID %>'), true);
            }
        }
            ...
            <table id="tblContent" width="75%" border="0" cellspacing="1" cellpadding="4" style="background: #CCC">
                <tr bgcolor="#FFFFFF">
                    <td colspan="3" class="lblData" style="height: 30px">
                        <span style="font-weight: bold;">LEO MUTHU - Scholarship Approve Panel (
                ...
                <tr bgcolor="#FFFFFF" id="trSuggestedAmount" runat="server">
                    ...
                    <td>
                        <asp:Label ID="lblSuggestedAmount" runat="server" Text="" Style="font-weight: bold;"></asp:Label>
                    </td>
                </tr>
                <tr bgcolor="#FFFFFF" id="tr1" runat="server">
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtApprovedAmt" runat="server" MaxLength="9" onkeyup="javascript:keyUP(this.value);"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="reQApprovedAmount" ControlToValidate="txtApprovedAmt"
                            targetcontrolid="txtApprovedAmt" Text="Please Enter Approved Amount" runat="server"
                            SetFocusOnError="True" />
                        <asp:Label ID="lbltextAmount" runat="server" Text=""></asp:Label><br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtApprovedAmt"
                ...
                <tr bgcolor="#FFFFFF" id="tr3" runat="server">
                    ...
                    <td>
                        <asp:TextBox ID="txtRemark" runat="server" MaxLength="500" TextMode="MultiLine" Text=""></asp:TextBox>
                        <asp:RequiredFieldValidator ID="reqRemark" ControlToValidate="txtRemark" targetcontrolid="txtRemark"
                            Text="Please enter Comments" runat="server" SetFocusOnError="True" />
                    </td>
                </tr>
                <tr bgcolor="#FFFFFF" id="trSuperAdminbutton" runat="server">
                    <td align="center" colspan="3">
                        <asp:Button ID="btnApprove" runat="server" Text="Approve" OnClientClick="fnConfirm();" OnClick="btnApprove_Click" />
                ...
                <tr bgcolor="#FFFFFF">
                    <td align="center" colspan="3">
                        ...
                        <asp:Label ID="lblApprovedAmount" runat="server" Visible="false"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
