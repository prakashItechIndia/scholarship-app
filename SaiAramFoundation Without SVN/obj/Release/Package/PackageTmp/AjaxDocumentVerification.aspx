<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxDocumentVerification.aspx.cs"
    Inherits="SaiAramFoundation.AjaxDocumentVerification" %>
        ...
        <asp:GridView ID="gvDisplayScholarship" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Process" ItemStyle-HorizontalAlign="Center">
                    <itemtemplate>
                        <asp:HyperLink ID="lnkVerify" class="inline1" NavigateUrl='<%#"Verify.aspx?applnno=" + Eval("Application_Id") + "&scholarshipId=1" %>'
                            runat="server" Text="Verify" style="color:#6C4AB4" Visible='<%#Convert.ToBoolean(Eval("VerifyLinkEnable")) %>'>
                        </asp:HyperLink>
                        <asp:HyperLink ID="lnkReVerified" class="inline1" NavigateUrl='<%#"ScolarshipReSuggest.aspx?applnno=" + Eval("Application_Id") + "&scholarshipId=1"  %>'
                            runat="server" style="color:Red" Text="Partial Verified" Visible='<%#Convert.ToBoolean(Eval("ReVerifyLinkEnable")) %>'>  
                     </asp:HyperLink>
                        <asp:Label ID="lblVerified" runat="server" style="font-weight: bold;color:#006DCC;font-size: 15px;" Text="Verified" Visible='<%#Convert.ToBoolean(Eval("lblVerified")) %>'></asp:Label>                        
                    </itemtemplate>
                    <ItemStyle Width="80px"></ItemStyle>
                </asp:TemplateField>
