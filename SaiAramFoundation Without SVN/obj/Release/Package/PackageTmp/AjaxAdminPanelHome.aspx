<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxAdminPanelHome.aspx.cs"
    Inherits="SaiAramFoundation.AjaxAdminPanelHome" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="gridView">
            <asp:GridView ID="gvDisplayScholarship" runat="server" AutoGenerateColumns="False"
                AllowPaging="False" OnRowDataBound="gvDisplayScholarship_RowDataBound" CssClass="table">
                <RowStyle />
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Scholarship Number" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lblScholarshipNumber" runat="server" Text='<%#Eval("Scholarship_No") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle></ItemStyle>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Print Details" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lnkPrintDetails" class="inline1" NavigateUrl='<%#"PrintDetails.aspx?applnno=" + Eval("Application_Id")+ "&scholarshipId=" +Eval("Scholarship_Id") %>'
                                runat="server" Text="Print Details" Visible='<%#Convert.ToBoolean(Eval("PrintLinkEnable")) %>'></asp:HyperLink>
                            <asp:Label ID="lblNotCompleted" runat="server" Text="---" Visible='<%#Convert.ToBoolean(Eval("lblNotCompleted")) %>'></asp:Label>
                            <asp:Label ID="lblSCReject" runat="server" Text="---" Visible='<%#Convert.ToBoolean(Eval("lblSCReject")) %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle></ItemStyle>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Prepared By" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lblPreparedBy" runat="server" Text='<%#Eval("Prepared_By") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Verified By" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lblVerifiedBy" runat="server" Text='<%#Eval("Verified_By") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Suggested By" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lblSuggestedBy" runat="server" Text='<%#Eval("Suggested_By") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle></ItemStyle>
                    </asp:TemplateField>
