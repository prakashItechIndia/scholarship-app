<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true"
    CodeBehind="DocumentVerification.aspx.cs" Inherits="SaiAramFoundation.DocumentVerification" %>
    ...
    <script type="text/javascript">
        ...
        function OnLoadBind() {
            ...
            var Key = document.getElementById("<% =txtKey.ClientID%>").value;
             ...
             xmlhttp.open("GET", "AjaxDocumentVerification.aspx?MainCategory=" + MaincatText + "&Key=" +Key+ "&AcyearId=" + AcyearId, true);
             xmlhttp.send();
