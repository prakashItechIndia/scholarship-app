<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxUploadDocument.aspx.cs"
    Inherits="SaiAramFoundation.AjaxUploadDocument" %>
            ...
            <asp:GridView ID="gvDisplayScholarship" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Documents" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lnkViewHistory" class="inline1" NavigateUrl='<%#"UploadPopup.aspx?applnno=" + Eval("Application_Id") %>'
                                runat="server" Text="Upload" Visible='<%#Convert.ToBoolean(Eval("UploadLinkEnable")) %>'></asp:HyperLink>
                            <asp:Label ID="lblPartialVerify" runat="server" Style="color: Red;" Text="[Partial]"
                                Visible='<%#Convert.ToBoolean(Eval("ReUploadLinkEnable")) %>'></asp:Label>
                            <asp:HyperLink ID="lnkREUpload" class="inline1" NavigateUrl='<%#"ScholarshipReUpload.aspx?applnno=" + Eval("Application_Id") %>'
                                runat="server" Text="Upload Again" Visible='<%#Convert.ToBoolean(Eval("ReUploadLinkEnable")) %>'></asp:HyperLink>
                            <asp:Label ID="lblApproved" runat="server" Text="Uploaded" Style="font-weight: bold; color: Green; font-size: 15px;" Visible='<%#Convert.ToBoolean(Eval("lblApproved")) %>'></asp:Label>

                            <%--<span id="SpPartialVerfy" style="color:Red" Visible="false">[Partial Verified]</span>--%>
                        </ItemTemplate>
                        <ItemStyle></ItemStyle>
                    </asp:TemplateField>
