<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true"
    CodeBehind="DDCheckAdminProccess.aspx.cs" Inherits="SaiAramFoundation.DDCheckAdminProccess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPnlHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnLoadBind() {
            ...
            xmlhttp.open("GET", "AjaxDDCheckAdminProccess.aspx?MainCategory=" + MaincatText + "&Key=" + Key + "&AcyearId=" + AcyearId, true);
            xmlhttp.send();
