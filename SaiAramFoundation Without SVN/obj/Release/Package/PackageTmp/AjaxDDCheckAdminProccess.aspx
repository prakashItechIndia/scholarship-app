<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxDDCheckAdminProccess.aspx.cs" 
Inherits="SaiAramFoundation.AjaxDDCheckAdminProccess" %>
        ...
        <asp:GridView ID="gvDisplayScholarship" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Process" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:HyperLink ID="lnkFinal"  class="inline1" NavigateUrl='<%#"ScholarshipFinal.aspx?applnno=" + Eval("Application_Id") + "&scholarshipId=" +Eval("Scholarship_Id") %>'
                        runat="server" Text='<%#Eval("DDCheckText") %>' Visible='<%#Convert.ToBoolean(Eval("DonateLinkEnable")) %>'></asp:HyperLink>                                  
                        
                                   
                      <asp:Label ID="lblDonated" runat="server" style="font-weight: bold;color:#046121;font-size: 15px;" Text="Issued" Visible='<%#Convert.ToBoolean(Eval("lblDonated")) %>'></asp:Label>                       
                    </ItemTemplate>
                    <ItemStyle Width="80px"></ItemStyle>
                </asp:TemplateField>
                   ...
                   <asp:TemplateField HeaderText="Print" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:HyperLink ID="lnkPrintFinal" class="inline1" NavigateUrl='<%#"AjaxPrintDDChequeDetails.aspx?applnno=" + Eval("Application_Id") + "&scholarshipId=" +Eval("Scholarship_Id") %>'
                            runat="server" Text="Final Form"></asp:HyperLink>
                    </ItemTemplate>
                    <ItemStyle></ItemStyle>
                </asp:TemplateField>
