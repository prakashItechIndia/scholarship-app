<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxSuggestHome.aspx.cs"
    Inherits="SaiAramFoundation.AjaxSuggestHome" %>
            ...
            <asp:GridView ID="gvDisplayScholarship" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Cheque Amount" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label ID="lblChequeAmount" runat="server" Text='<%#Eval("Scholarship_Approved_Amount") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle></ItemStyle>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Print Details" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="lnkPrintDetails" class="inline1"  NavigateUrl='<%#"AjaxReportPrintApproval.aspx?applnno=" + Eval("Application_Id")+ "&scholarshipId=" +Eval("Scholarship_Id") %>'
                                runat="server" Text="Print Details" Visible="true"></asp:HyperLink>
                            |
                        <asp:HyperLink ID="lnkPrintFinal" class="inline1" NavigateUrl='<%#"AjaxPrintDDChequeDetails.aspx?applnno=" + Eval("Application_Id")+ "&scholarshipId=" +Eval("Scholarship_Id") %>'
                            runat="server" Text="Final Form" Visible="true"></asp:HyperLink>
                        </ItemTemplate>
                        <ItemStyle></ItemStyle>
                    </asp:TemplateField>
