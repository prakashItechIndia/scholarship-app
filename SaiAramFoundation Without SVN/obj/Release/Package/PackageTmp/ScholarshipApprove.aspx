<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScholarshipApprove.aspx.cs" Inherits="SaiAramFoundation.ScholarshipApprove" %>
    ...
    <script type="text/javascript">
        ...
        function Validation(event) {
            ...
            if (remark == "") {
                ...
                ValidatorEnable(document.getElementById('<%= reQApprovedAmount.ClientID %>'), false);
        ...
        function Validation1(event) {
            //alert(document.getElementById('<%= txtApprovedAmt.ClientID %>').value + "              " + parseInt(document.getElementById('<%= lblSuggestedAmount.ClientID %>').innerHTML));
