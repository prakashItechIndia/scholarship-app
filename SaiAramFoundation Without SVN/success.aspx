...
<body>
    ...
    <div class="header">
        <div class="container">
            <div class="row">
                 <div class="col-md-1">
                    <img alt="" src="~/../images/logo-aram.png" width="80" />
                </div>
                <div class="col-md-10">
                    <h1 class="logo-name">
        ...
        <div class="form-holder">
            <div class="row">
               ...
               <iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fadmission.sairamgroup.in%2F&width=450&layout=standard&action=recommend&show_faces=true&share=true&height=80"
                   ...
                   style="display:block;margin:0px auto;border: none; overflow: hidden; width: 450px;margin-bottom:20px; height: 80px;" allowtransparency="true"></iframe>
