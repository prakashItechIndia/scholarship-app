...
{
    public partial class AjaxReportForScholarshipIssued : System.Web.UI.Page
    {
            ...
            try
            {
                if (Session["User_ID"] != null && Session["Roles_Id"] != null)
                {
                    ...
                    if (intRoleId == 1 || intRoleId == 4 || intRoleId == 7 || intRoleId == 8)
                    {
                        ...
                        {
                            strPrint = Request.QueryString["Option"];
                            if (Request.QueryString["FileName"] != null)
                            {
                                strExportFile = Request.QueryString["FileName"];
                            }
                            else
                            {
                                strExportFile = "ScholarshipChequesIssuedReport.xls";
                            }
                        }
                        else
                        {
                        ...
                        InitializeReport();
                        rpt = (ReportDocument)Session["ReportObjectIssued"];
                        Session["ReportObjectIssued"] = null;
                        FinalizeReport();
            ...
            try
            {
                ...
                if (tblCount != 0)
                {
                    ...
                    else
                    {
                        ...
                        Response.AddHeader("Content-Disposition", "attachment; filename=" + "ScholarshipChequesIssuedReport.pdf");
