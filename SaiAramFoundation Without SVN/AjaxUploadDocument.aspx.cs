...
{
    public partial class AjaxUploadDocument : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ds = GetUploadData(Request.QueryString["MainCategory"].Trim().ToString(), Request.QueryString["Key"].Trim().ToString(), Request.QueryString["AcyearId"].Trim().ToString());
                    ...
                    else
                    {
                        ...
                        //    objCommon.fncBindIssuedAmount(strAadharId, gvDisplayPreviousScholarshipDetails, lblAlreadyApplied);
        ...
        public DataSet GetUploadData(string MainCategory, string Key, string AcyearId)
        {
            ...
            try
            {
                ...
                strQuery = strQuery + " R.Student_ID,R.Applicant_Name,R.Guardian_Name ,R.Father_Name,R.Aadhaar_ID,";
                ...
                strQuery = strQuery + " R.IFSC_Code,P.Scholarship_Issued_AccNo,P.User_ID,P.Status,P.Update_Date,P.Scholarship_Id,";

                strQuery = strQuery + " case P.IsUpload_Status when '0' then 'False' when '1' then 'True' when '2' then 'False' else 'False' end as [ReUploadLinkEnable] , ";
                strQuery = strQuery + " case P.IsUpload_Status when '0' then 'False' when '1' then 'False' when '2' then 'True' else 'False' end as [UploadLinkEnable] , ";
                strQuery = strQuery + " case P.IsUpload_Status when '0' then 'True' when '1' then 'False' when '2' then 'False' else 'False' end as [lblApproved] ";
                ...
                strQuery = strQuery + " Where P.Status in ('Registered')";
                ...
                strQuery = strQuery + " order by UploadLinkEnable desc";
