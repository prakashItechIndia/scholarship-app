<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true"
    CodeBehind="AdminPanelProcess.aspx.cs" Inherits="SaiAramFoundation.AdminPanelProcess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPnlHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnLoadBind() {
            ...
            xmlhttp.open("GET", "AjaxAdminPanelProcess.aspx?MainCategory=" + MaincatText + "&Key=" + Key + "&AcyearId=" + AcyearId, true);
            xmlhttp.send();
    ...
    <form runat="server">
        ...
        <div>
            <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSearch">
                <asp:Label runat="server" Text="Main Category"></asp:Label>
