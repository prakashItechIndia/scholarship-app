    ...
    public partial class Verify : System.Web.UI.Page
    {
        ...
        public void PopulateData()
        {
            ...
            try
            {
                ...
                {
                    hideApplicationId.Value = dsData.Tables[0].Rows[0]["Application_Id"].ToString().Trim();
                    lblSchlorshipYear.Text = dsData.Tables[0].Rows[0]["ScholarshipYear_Name"].ToString().Trim();
                    txtName.Text = dsData.Tables[0].Rows[0]["Applicant_Name"].ToString().Trim();
                    txtStudentId.Text = dsData.Tables[0].Rows[0]["Student_ID"].ToString().Trim();

                    txtAadhaarID.Text = dsData.Tables[0].Rows[0]["Aadhaar_ID"].ToString().Trim();
                    if (string.IsNullOrEmpty(dsData.Tables[0].Rows[0]["Aadhaar_ID"].ToString().Trim()))
                    {
                    ...
                    txtPanId.Text = dsData.Tables[0].Rows[0]["Pan_ID"].ToString().Trim();
                    if (string.IsNullOrEmpty(dsData.Tables[0].Rows[0]["Pan_ID"].ToString().Trim()))
                    {
                    ...
                    fncBindIssuedAmount(dsData.Tables[0].Rows[0]["Aadhaar_ID"].ToString().Trim(), dsData.Tables[0].Rows[0]["Pan_ID"].ToString().Trim());

                    lblApplnNo.Text = dsData.Tables[0].Rows[0]["Application_Id"].ToString().Trim();
                    txtFatherName.Text = dsData.Tables[0].Rows[0]["Father_Name"].ToString().Trim();
            ...
            try
            {
                lock (lckThis)
                {
                    ...
                    else
                    {
                        ...
                        string strText = "Documents are Verified by <b> " + Session["User_ID"].ToString() + " </b>";
                        objApprove.UpdateHistory(lblApplnNo.Text, strText, "Document Verification ", Session["User_ID"].ToString());
