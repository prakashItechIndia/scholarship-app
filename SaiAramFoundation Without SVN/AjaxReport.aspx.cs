                ...
                if (Session["User_ID"] != null && Session["Roles_Id"] != null)
                {
                    ...
                    if (intRoleId == 1 || intRoleId == 4 || intRoleId == 7 || intRoleId == 8)
                    {
                        ...
                        if (Request.QueryString["Option"] != null)
                        {
                            ...
                            {
                                strExportFile = "ScholarshipCategorieswiseReport.xls";
                            }
                        }
                        else
                        {
                        ...
                        InitializeReport();
                        rpt = (ReportDocument)Session["ReportObject"];
            ...
            try
            {
                ...
                if (tblCount != 0)
                {
                    ...
                    else
                    {
                        ...
                        Response.AddHeader("Content-Disposition", "attachment; filename=" + "ScholarshipCategorieswiseReport.pdf");
