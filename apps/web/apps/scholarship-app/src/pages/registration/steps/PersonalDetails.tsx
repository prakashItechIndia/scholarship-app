                        ...
                        <Stack horizontal verticalAlign="center" tokens={{ childrenGap: 16 }}>
                            ...
                            >
                                ...
                                {(isHovered || photoPreview) && (
                                    <div className={`absolute inset-0 flex items-center justify-center rounded-full transition-opacity duration-300 ${photoPreview ? 'bg-black bg-opacity-40 hover:bg-opacity-60' : 'bg-black bg-opacity-50'
                                        }`}>
