      ...
      <div style={{ width: "100%", overflowX: "auto" }}>
        <svg width={chartWidth} height={chartHeight + paddingTop + paddingBottom} style={{ overflow: "visible" }}>
          ...
          <line
            ...
            strokeDasharray="4,4"
          />
          <circle cx={getX(5)} cy={getY(data?.[5]?.budget2024 || 0)} r="6" fill="#3b82f6" />
          <g transform={`translate(${getX(5) - 45}, ${getY(data?.[5]?.budget2024 || 0) - 40})`}>
          ...
          <line
            ...
            strokeDasharray="4,4"
          />
          <circle cx={getX(9)} cy={getY(data?.[9]?.budget2025 || 0)} r="6" fill="#ef4444" />
          <g transform={`translate(${getX(9) + 10}, ${getY(data?.[9]?.budget2025 || 0) - 10})`}>
