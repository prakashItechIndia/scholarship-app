...
exports.getUserInvitationEmailTemplate = getUserInvitationEmailTemplate;
exports.getUserInvitationEmailText = getUserInvitationEmailText;
exports.getForgotPasswordEmailTemplate = getForgotPasswordEmailTemplate;
exports.getForgotPasswordEmailText = getForgotPasswordEmailText;
exports.getChangePasswordEmailTemplate = getChangePasswordEmailTemplate;
exports.getChangePasswordEmailText = getChangePasswordEmailText;
exports.getWelcomeEmailTemplate = getWelcomeEmailTemplate;
exports.getWelcomeEmailText = getWelcomeEmailText;
const image_utils_1 = require("../utils/image-utils");
function buildEmailTemplate(content) {
    const { salutationName, title, subtitle, heroImageKey = 'invitation-illustration', paragraphs, cta, copyInstruction, expiryNotice, } = content;
    const icapturLogo = (0, image_utils_1.getImageDataUri)('icaptur-logo');
    const itechLogo = (0, image_utils_1.getImageDataUri)('itech-logo');
    const hero = (0, image_utils_1.getImageDataUri)(heroImageKey);
    const copyIcon = (0, image_utils_1.getImageDataUri)('copy-icon');
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td style="padding-bottom:20px;">
                    ...
                    ${paragraphs
        .map((text) => `<p style="margin:0 0 12px 0; font-family:'Inter', sans-serif; font-size:16px; font-weight:400; color:#595959; line-height:1.6;">${text}</p>`)
        .join('')}
                  </td>
                </tr>
              </table>
...
function buildTextVersion({ salutationName, title, subtitle, paragraphs, cta, expiryNotice, }) {
 ...
 */
function getUserInvitationEmailTemplate(data) {
    const { firstName, activationUrl, organizationName, inviterName, productName } = data;
    ...
    return buildEmailTemplate({
        ...
        copyInstruction: 'Or, copy and paste this link into your browser',
        expiryNotice: 'Important notice: This email link will expire in 7 days. If you did not expect this invitation, you can safely ignore this email.',
    });
}
function getUserInvitationEmailText(data) {
    const { firstName, activationUrl, organizationName, inviterName, productName } = data;
    const invitationText = inviterName
        ? `${inviterName} has invited you to access ${productName || organizationName}`
        : `You have been invited to access ${productName || organizationName}`;
 ...
 */
function getForgotPasswordEmailTemplate(data) {
    return buildEmailTemplate({
        ...
        expiryNotice: 'Important notice: This reset link will expire in 30 minutes for security.',
    });
}
function getForgotPasswordEmailText(data) {
    return buildTextVersion({
        salutationName: data.firstName,
        title: { lead: 'Reset your', highlight: 'password' },
        subtitle: 'Securely continue to your iCaptur account',
 ...
 */
function getChangePasswordEmailTemplate(data) {
    return buildEmailTemplate({
        salutationName: data.firstName,
        ...
        expiryNotice: 'Important notice: This change link will expire in 30 minutes for security.',
    });
}
function getChangePasswordEmailText(data) {
    return buildTextVersion({
        salutationName: data.firstName,
        title: { lead: 'Change your', highlight: 'password' },
        subtitle: 'Keep your iCaptur account secure',
...
function getWelcomeEmailTemplate(data) {
    ...
    return buildEmailTemplate({
        ...
        copyInstruction: 'Or, copy and paste this link into your browser',
        expiryNotice: 'If you did not create this account, please ignore this email.',
    });
}
function getWelcomeEmailText(data) {
    const orgName = data.organizationName || 'iCaptur';
    return buildTextVersion({
        salutationName: data.firstName,
        title: { lead: 'Welcome to', highlight: 'iCaptur!' },
